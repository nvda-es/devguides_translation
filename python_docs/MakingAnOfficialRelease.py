...
_(u"""  * [Add a new section to the change log](#new-section-in-changes-file)."""),
...
_(u"""* Create a PR to update espeak, and create and issue on the [espeak-ng repo asking for a new release](https://github.com/espeak-ng/espeak-ng/issues/new). [See discussion](https://github.com/espeak-ng/espeak-ng/issues/792)."""),
_(u"""* If this is a 20XY.1 release, create a PR to update the Addon API `BACK_COMPAT_TO` version to match this version number for this release cycle."""),
_(u"""  - This PR does not need be merged until branching for the beta of the 20XY.1 release."""),
_(u"""  - The existence of the PR is intended to act as an early warning for add-on developers of the coming change."""),
...
_(u"""- A beta doesn't need a pre-release entry on GitHub. Save that for RC and releases"""),
_(u"""  - We have been inconsistent about this in the past."""),
...
_(u"""- Add a description pointing to the release post on nvaccess.org:"""),
_(u"""  - ``` Highlights and download links can be found in the release blog post at: https://www.nvaccess.org/post/nvda-2021-1rc2/ ```"""),
_(u"""  - For subsequent RC / Release can describe important additions & removals."""),
...
_(u"""- Submit the download URL from the NV Access site."""),
...
"",_(u"""## New section in changes file"""),
_(u"""Add to the top of the changes file:"""),
_(u"""```"""),
_(u"""= 20XY.Z ="""),
"",_(u"""== New Features =="""),
"","",_(u"""== Changes =="""),
...
"","",_(u"""```"""),
_(u"""* If this is a 20XY.1 release add to the \"Changes for Developers\" section:"""),
_(u"""`- Note: this is a Add-on API compatibility breaking release. Add-ons will need to be re-tested and have their manifest updated.`"""),
]