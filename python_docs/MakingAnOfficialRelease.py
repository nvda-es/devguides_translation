...
_(u"""* Create a [new pre-release / annotated tag](#create-the-release--annotated-tag)"""),
...
_(u"""* [Publicize the release.](#publicize-the-release)"""),
"",_(u"""## Final release"""),
_(u"""* Create a [new release / annotated tag](#create-the-release--annotated-tag)"""),
_(u"""* Wait for the `appVeyor` build to complete."""),
_(u"""* [Scan the launcher executable](#scan-the-build)"""),
_(u"""* [Publish the staged release](#publish-the-staged-release)"""),
_(u"""* [Publicize the release.](#publicize-the-release)"""),
...
_(u"""* Update `master` version number and changes file are correct"""),
...
_(u"""* Convert annotated tag into a GitHub release with the [GitHub new release page](https://github.com/nvaccess/nvda/tags)"""),
_(u"""  - Click on the tag menu button, shown as \"...\" and choose \"Create Release\""""),
_(u"""  - Release Title example: `Release 2019.2beta3`, """),
_(u"""  - No description necessary for first beta / RC / Release, subsequent beta / RC / Release can describe important additions / removals."""),
_(u"""  - For `beta` and `RC`, ensure option \"This is a pre-release\" is checked."""),
"",_(u"""### Reasoning"""),
