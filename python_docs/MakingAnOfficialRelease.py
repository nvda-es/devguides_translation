...
"",_(u"""## Betas"""),
_(u"""* Ensure beta branch has required changes:"""),
_(u"""  - Choose a point where master is healthy (all checks passing and no known regressions)"""),
_(u"""  - Merge master into beta"""),
_(u"""* Ensure these changes have had some alpha level testing."""),
_(u"""  - The most recent (significant) change on beta should have had at least one week of alpha testing."""),
_(u"""* Tag beta1. E.g. release-2019.1beta1."""),
_(u"""  - ?? command line or via Github new release url (with pre-release)?"""),
_(u"""  - beta will now show up on the snapshots page"""),
_(u"""  - the auto update system will start offering it to those checking for betas"""),
