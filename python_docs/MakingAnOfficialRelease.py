...
_(u"""  - This will be the branch off point for the new release. Prior to this (but after the previous \"final\" release) master can be merged into beta at any point. After the branch of point master will move on and PR's required in this release should target the beta branch."""),
...
_(u"""* [Update auto milestone ID](#update-auto-milestone-id)"""),
