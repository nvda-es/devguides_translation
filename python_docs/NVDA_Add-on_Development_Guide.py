...
_(u"""- <a href=\"#user-content-add-on-basics\">Add-on Basics</a>"""),
_(u"""  - <a href=\"#user-content-what-are-add-ons\">What are Add-ons?</a>"""),
_(u"""  - <a href=\"#user-content-what-are-add-on-modules\">What Are Add-on Modules?</a>"""),
_(u"""  - <a href=\"#user-content-what-are-add-on-packages\">What Are Add-on Packages?</a>"""),
...
"",_(u"""If you are coming from NVDA 2018.4 or earlier, you may recall that you are able to run extension modules inside folders stored in the user configuration directory (e.g. appModules). This functionality has been revised in NVDA 2019.1 as follows:"""),
...
_(u"""	2. You must check \"I understand that changing these settings may cause NVDA to function incorrectly\"."""),
...
_(u"""support for an application, or adding support for newer braille displays or speech synthesizers."""),
"",_(u"""Note: add-ons are sometimes called \"Plugins\", especially in the [NVDA Developer Guide]. In general, we will call them add-ons in this guide for the sake of clarity, but just be aware that they are the same thing."""),
...
"",_(u"""Add-ons can act globally (across all of NVDA), in a specific application or program, or behind the scenes (at the hardware level). We call these three """),
_(u"""major areas \"modules\". Every add-on contains at least one module, which is just one or more Python files designed to act in one of those three specific """),
...
_(u"""  - Even better: we recommend installing the latest master development version to keep up to date with core API changes. You can download the latest snapshots at https://community.nvda-project.org/wiki/Snapshots."""),
_(u"""* Python:"""),
_(u"""  - Python 2.7 series, version 2.7.14 32-bit for Windows: https://www.python.org/downloads/release/python-2714/"""),
_(u"""  - If you wish to work with Python 3, use Python 3.7.3, 32-bit for Windows: https://www.python.org/downloads/release/python-373/"""),
...
_(u"""* Optional Items:"""),
_(u"""  - Git 1.7.9 or later if you wish to upload the add-on to a repository such as [Bitbucket] or [Github] (optional. See below). You can use various Git clients, such as [Git Bash], [Cygwin's Git][Git for Cygwin], and [TortoiseGit]."""),
...
"",_(u"""Note: if using Windows 10 Anniversary Update or later and wish to use Ubuntu on Windows (AKA [Windows Subsystem for Linux][WSL]), you can use Advanced Packaging Tool (APT) to obtain SCons and Gettext. You can then use pip to download and install Markdown."""),
