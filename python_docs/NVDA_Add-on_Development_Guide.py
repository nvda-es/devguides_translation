...
_(u"""[1]: https://github.com/nvaccess/nvda"""),
_(u"""[2]: https://www.nvaccess.org/files/nvda/documentation/developerGuide.html"""),
_(u"""[3]: https://bitbucket.org/nvdaaddonteam/addontemplate/get/master.zip"""),
_(u"""[Python Console]: <https://www.nvaccess.org/files/nvda/documentation/developerGuide.html#PythonConsole> (NVDA Developer Guide: The Python Console)"""),
_(u"""[4]: http://www.zlotowicz.pl/nvda/winapi.mdwn"""),
_(u"""[5]: https://addons.nvda-project.org"""),
_(u"""[6]: https://www.git-scm.com/josephsl/stationPlaylist"""),
"",_(u"""# NVDA Add-on Development Guide"""),
"",_(u"""Latest version: April 2019 for NVDA 2019.1"""),
"",_(u"""---"""),
...
"",_(u"""- <a href=\"#user-content-authors-contributions-and-copyright\">Authors, Contributions, and Copyright</a>"""),
_(u"""- <a href=\"#user-content-introduction\">Introduction</a>"""),
_(u"""- <a href=\"#user-content-audience\">Audience</a>"""),
_(u"""  - <a href=\"#user-content-special-note-on-python-version\">Special note on Python version</a>"""),
_(u"""  - <a href=\"#user-content-a-special-note-for-scripters-of-other-screen-readers\">A special note for scripters of other screen readers</a>"""),
_(u"""  - <a href=\"#user-content-a-special-note-about-windows-store-version-of-nvda\">A special note about Windows Store version of NVDA</a>"""),
_(u"""  - <a href=\"#user-content-a-very-important-note-about-migrating-custom-extension-code-to-development-scratchpad\">A very important note about migrating custom extension code to development scratchpad</a>"""),
_(u"""- <a href=\"#user-content-what-are-add-ons\">What are Add-ons?</a>"""),
_(u"""  - <a href=\"#user-content-add-on-module-types\">Add-on Module Types</a>"""),
_(u"""  - <a href=\"#user-content-installing-nvda-add-ons\">Installing NVDA Add-ons</a>"""),
_(u"""- <a href=\"#user-content-setting-up-the-add-on-development-environment\">Setting up the add-on development environment</a>"""),
_(u"""  - <a href=\"#user-content-meet-system-requirements\">Meet System requirements</a>"""),
_(u"""  - <a href=\"#user-content-add-on-development-folder-structure\">Add-on Development Folder Structure</a>"""),
_(u"""  - <a href=\"#user-content-add-on-folder-structure\">Add-on folder structure</a>"""),
_(u"""  - <a href=\"#user-content-packaging-add-ons\">Packaging add-ons</a>"""),
_(u"""- <a href=\"#user-content-getting-started-hands-on-examples\">Getting started: Hands-on examples</a>"""),
_(u"""  - <a href=\"#user-content-how-add-on-code-is-organized\">How add-on code is organized</a>"""),
_(u"""  - <a href=\"#user-content-running-your-add-on-in-this-example-chapter\">Running your add-on in this example chapter</a>"""),
_(u"""  - <a href=\"#user-content-example-1-hear-a-tone-when-pressing-nvdaa\">Example 1: Hear a tone when pressing NVDA+A</a>"""),
_(u"""  - <a href=\"#user-content-example-1-code-explanation\">Example 1 code explanation</a>"""),
_(u"""  - <a href=\"#user-content-i-dont-understand-those-above-terms\">I don't understand those above terms</a>"""),
_(u"""  - <a href=\"#user-content-example-2-generate-a-tone-when-switching-to-notepad\">Example 2: Generate a tone when switching to Notepad</a>"""),
_(u"""  - <a href=\"#user-content-example-2-code-explanation\">Example 2 code explanation</a>"""),
_(u"""  - <a href=\"#user-content-more-new-terms-please\">More new terms please</a>"""),
_(u"""  - <a href=\"#user-content-a-few-tips-for-beginners\">A few tips for beginners</a>"""),
_(u"""- <a href=\"#user-content-useful-modules-from-nvda-core\">Useful modules from NVDA core</a>"""),
_(u"""  - <a href=\"#user-content-list-of-useful-nvda-core-modules-and-methods\">List of useful NVDA core modules and methods</a>"""),
_(u"""  - <a href=\"#user-content-example-1-am-i-on-the-right-app-where-the-focus-is-located\">Example 1: am I on the right app where the focus is located?</a>"""),
_(u"""  - <a href=\"#user-content-example-2-display-a-message-on-a-browse-mode-document\">Example 2: Display a message on a browse mode document</a>"""),
_(u"""  - <a href=\"#user-content-example-3-announce-the-automation-id-of-a-uia-object\">Example 3: Announce the automation ID of a UIA object</a>"""),
_(u"""  - <a href=\"#user-content-example-4-send-keystrokes\">Example 4: Send keystrokes</a>"""),
_(u"""  - <a href=\"#user-content-example-5-stop-speech-whenever-screen-content-changes-if-dynamic-content-change-announcement-is-off\">Example 5: Stop speech whenever screen content changes if dynamic content change announcement is off</a>"""),
_(u"""- <a href=\"#user-content-add-on-module-components-and-development-tips\">Add-on module components and development tips</a>"""),
_(u"""  - <a href=\"#user-content-the-python-console\">The Python Console</a>"""),
_(u"""  - <a href=\"#user-content-working-with-objects-on-screen\">Working with objects on screen</a>"""),
_(u"""  - <a href=\"#user-content-examining-object-hierarchy\">Examining object hierarchy</a>"""),
_(u"""  - <a href=\"#user-content-focus-vs-navigator-object\">Focus vs. navigator object</a>"""),
_(u"""  - <a href=\"#user-content-other-useful-object-related-goodies\">Other useful object-related goodies</a>"""),
_(u"""  - <a href=\"#user-content-example-1-finding-the-value-of-a-slider-in-a-program\">Example 1: Finding the value of a slider in a program</a>"""),
_(u"""  - <a href=\"#user-content-specialist-objects-and-overriding-object-properties-at-runtime\">Specialist objects and overriding object properties at runtime</a>"""),
_(u"""  - <a href=\"#user-content-examples-of-overlay-classes-and-modified-roles\">Examples of overlay classes and modified roles</a>"""),
_(u"""  - <a href=\"#user-content-input-and-output-scripts-and-ui-messages\">Input and output: scripts and UI messages</a>"""),
_(u"""  - <a href=\"#user-content-example-2-a-basic-script-dictionary-and-message-output\">Example 2: A basic script dictionary and message output</a>"""),
_(u"""  - <a href=\"#user-content-example-3-scripts-for-specific-objects\">Example 3: Scripts for specific objects</a>"""),
_(u"""  - <a href=\"#user-content-script-lookup-order-and-command-conflicts\">Script lookup order and command conflicts</a>"""),
_(u"""  - <a href=\"#user-content-few-other-remarks-on-scripts\">Few other remarks on scripts</a>"""),
_(u"""  - <a href=\"#user-content-events\">Events</a>"""),
_(u"""  - <a href=\"#user-content-example-4-announcing-the-changed-name-of-a-control\">Example 4: Announcing the changed name of a control</a>"""),
_(u"""  - <a href=\"#user-content-list-of-possible-events\">List of possible events</a>"""),
_(u"""  - <a href=\"#user-content-events-within-objects\">Events within objects</a>"""),
_(u"""  - <a href=\"#user-content-other-components\">Other components</a>"""),
_(u"""  - <a href=\"#user-content-lets-build-an-add-on\">Let's build an add-on</a>"""),
_(u"""  - <a href=\"#user-content-add-on-planning-and-development-tips\">Add-on planning and development tips</a>"""),
_(u"""  - <a href=\"#user-content-dos-and-donts\">Do's and don'ts</a>"""),
_(u"""  - <a href=\"#user-content-frequently-asked-questions-about-add-on-components-and-development\">Frequently Asked Questions about add-on components and development</a>"""),
_(u"""- <a href=\"#user-content-introduction-to-global-plugins\">Introduction to global plugins</a>"""),
_(u"""  - <a href=\"#user-content-typical-development-plan-for-global-plugins\">Typical development plan for global plugins</a>"""),
_(u"""  - <a href=\"#user-content-the-global-plugin-code\">The global plugin code</a>"""),
_(u"""  - <a href=\"#user-content-when-to-write-or-not-write-global-plugins\">When to write or not write global plugins</a>"""),
_(u"""  - <a href=\"#user-content-few-more-things-to-remember-about-global-plugins\">Few more things to remember about global plugins</a>"""),
_(u"""  - <a href=\"#user-content-example-1-writing-computer-braille-using-qwerty-keyboard\">Example 1: Writing computer braille using QWERTY keyboard</a>"""),
_(u"""  - <a href=\"#user-content-exercises\">Exercises</a>"""),
_(u"""- <a href=\"#user-content-introduction-to-app-modules\">Introduction to app modules</a>"""),
_(u"""  - <a href=\"#user-content-differences-between-app-modules-and-global-plugins\">Differences between app modules and global plugins</a>"""),
_(u"""  - <a href=\"#user-content-app-module-development-process-and-strategies\">App module development process and strategies</a>"""),
_(u"""  - <a href=\"#user-content-example-2-simple-app-module-in-notepad\">Example 2: Simple app module in Notepad</a>"""),
_(u"""  - <a href=\"#user-content-example-3-silencing-nvda-in-openbook\">Example 3: Silencing NVDA in Openbook</a>"""),
_(u"""  - <a href=\"#user-content-example-4-announcing-control-property-changes-while-using-another-app\">Example 4: Announcing control property changes while using another app</a>"""),
_(u"""  - <a href=\"#user-content-useful-app-module-properties-and-methods\">Useful app module properties and methods</a>"""),
_(u"""  - <a href=\"#user-content-other-remarks-on-app-modules\">Other remarks on app modules</a>"""),
_(u"""- <a href=\"#user-content-drivers\">Drivers</a>"""),
_(u"""  - <a href=\"#user-content-driver-components\">Driver components</a>"""),
_(u"""  - <a href=\"#user-content-few-important-things-to-remember-before-during-and-after-driver-development\">Few important things to remember before, during and after driver development</a>"""),
_(u"""  - <a href=\"#user-content-typical-driver-development-steps\">Typical driver development steps</a>"""),
_(u"""- <a href=\"#user-content-sharing-your-add-on-and-experience-with-others\">Sharing your add-on and experience with others</a>"""),
_(u"""  - <a href=\"#user-content-the-nvda-add-ons-list\">The NVDA Add-ons list</a>"""),
_(u"""  - <a href=\"#user-content-the-nvda-community-add-ons-web-site-and-code-repository\">The NVDA Community Add-ons web site and code repository</a>"""),
_(u"""- <a href=\"#user-content-miscellaneous-information\">Miscellaneous information</a>"""),
_(u"""- <a href=\"#user-content-appendicies\">Appendicies</a>"""),
_(u"""  - <a href=\"#user-content-appendix-a-add-on-terms-dictionary\">Appendix A: add-on terms dictionary</a>"""),
_(u"""  - <a href=\"#user-content-appendix-b-programming-and-python-concepts-every-add-on-developer-needs-to-know\">Appendix B: Programming and Python concepts every add-on developer needs to know</a>"""),
_(u"""  - <a href=\"#user-content-appendix-c-add-on-type-comparison\">Appendix C: Add-on type comparison</a>"""),
_(u"""  - <a href=\"#user-content-appendix-d-notes-and-references-for-scripters-of-other-screen-readers\">Appendix D: notes and references for scripters of other screen readers</a>"""),
"",_(u"""---"""),
"",_(u"""[//]: # (End of TOC)"""),
"",_(u"""## Authors, Contributions, and Copyright"""),
"",_(u"""This guide was originally written by Joseph Lee, and is shaped by the NVDA user and developer community. We welcome your feedback and contributions."""),
"",_(u"""NVDA is copyright 2006-2019 NV Access Limited. Microsoft Windows, Microsoft Office, Win32 API, and other Microsoft  products are copyright Microsoft Corporation. the IAccessible package is copyright by IBM and the Linux Foundation. Python is copyright by Python Software Foundation. Other products mentioned are copyrighted by their respective copyright holders."""),
"",_(u"""## Introduction"""),
...
"",_(u"""For more information on NVDA development, please visit the [NVDA GitHub page][1]. Be sure to go over the [NVDA Developer Guide][2] to familiarize yourself with key terms and basics on getting started with add-on development."""),
"",_(u"""## Audience"""),
...
_(u"""* Python, and consequently, NVDA is an object-oriented system. In other words, most of your code will consist of defining classes and objects which are than picked up by NVDA at runtime."""),
...
"",_(u"""As of NVDA 2018.1, foundation has been laid to let NVDA run as a Windows Store application. Once the Windows Store version of NVDA is published to Microsoft Store, users running Windows 10 can go to Store and obtain NVDA. However, there are restrictions that comes with this version of NVDA, notably add-ons cannot run in this environment. Thus, if you need to run or write NVDA add-ons, you need to use the classic desktop version of NVDA, available from nvaccess.org website."""),
"",_(u"""### A very important note about migrating custom extension code to development scratchpad"""),
"",_(u"""If you are coming from NVDA 2018.4 or earlier, you may recall that you are able to run extension modules inside folders stored in user configuration directory (e.g. appModules). This functionality has been revised in NVDA 2019.1 as follows:"""),
"",_(u"""1. NVDA will no longer load extension code stored in the following subdirectories of user configuration folder: appModules, brailleDisplayDrivers, globalPlugins, synthDrivers."""),
_(u"""	* If you find that code inside these folders are no longer working as of NVDA 2019.1, the above reason is why."""),
...
_(u"""	1. With NVDA 2019.1 running, go to NVDA menu/Preferences/settings/Advanced."""),
_(u"""	2. You must check \"I understand that changing these settings may cause NVDA to function incorrectly\" checkbox."""),
_(u"""	3. You must check \"Enable loading custom code from Developer Scratchpad directory\"."""),
_(u"""	4. Select OK."""),
_(u"""3. You must store code that were formerly housed in the above list of subdirectories inside corresponding subdirectories of scratchpad folder."""),
_(u"""4. If you need to use NVDA 2018.4 and would like to use custom code, you must not remove subdirectories from user configuration directory, otherwise go ahead and remove the folders listed in item 1."""),
"",_(u"""## What are Add-ons?"""),
"",_(u"""Add-ons are additional packages that extend NVDA's functionality or support for programs. This may include adding global features, enhancing support for an application, or adding support for newer braille displays or speech synthesizers. Add-ons may contain more than one module. The following is a general description of add-on module types."""),
"",_(u"""### Add-on Module Types"""),
...
_(u"""* Driver: A driver allows a program to talk to hardware. Currently you can write drivers for new braille displays or speech synthesizers."""),
"",_(u"""### Installing NVDA Add-ons"""),
"",_(u"""Each NVDA add-on package is a zip file with the file extension of .nvda-addon. You can install add-on modules via the Add-ons Manager in NVDA 2012.2 or later. Alternatively, you can install them from File Manager if you use NVDA 2012.3 or later."""),
"",_(u"""## Setting up the add-on development environment"""),
...
"",_(u"""* A version of NVDA is available on your computer (either a portable or installed version will work, but we strongly recommend that you install a copy of NVDA on your development computer). Download NVDA from the NV Access page at https://www.nvaccess.org."""),
_(u"""	* We recommend installing the latest master development version to keep up to date with core API changes. You can download the latest snapshots at https://community.nvda-project.org/wiki/Snapshots."""),
_(u"""* Python 2.7 series, version 2.7.14 32-bit for Windows: <https://www.python.org/download/releases/2.7.14/>."""),
_(u"""	* If you wish to work with Python 3, use Python 3.7.3, 32-bit for Windows."""),
_(u"""* SCons 2 or 3, version 2.3.0 or later for generating add-on packages (if using a 3.x release, use 3.0.1 or later): <http://www.scons.org/>."""),
...
_(u"""	* Once downloaded, copy both exe files to your add-on development folder. See the next section for a description of the add-on folder structure."""),
_(u"""* Git 1.7.9 or later if you wish to upload the add-on to a repository such as Bitbucket (optional. See below). You can use various Git clients, such as Git Bash, Cygwin's Git, and Tortoise Git."""),
_(u"""* The NVDA Community Add-on Template for ease of add-on file and folder packaging and management (optional. [Download the add-on template)][3] ."""),
...
"",_(u"""Note: if using Windows 10 Anniversary Update or later and wish to use Ubuntu on Windows (aka Windows Subsystem for Linux), you can use Advanced Packaging Tool (APT) to obtain SCons and Gettext. You can then use pip to download and install Markdown."""),
...
"",_(u"""Once you install the needed dependencies (see above), paste the Gettext package executables into this add-on folder."""),
...
_(u"""* An \"addon\" subfolder with the add-on module directory underneath this subfolder (appModules, globalPlugins, synthDrivers, brailleDisplays). One or more module folders can be specified."""),
...
"",_(u"""First, you start by writing an optional header for your add-on, such as your name, a brief sentence or two on what the add-on is for and so on. Although this is optional, it is recommended that you write the header as a reminder to keep track of what you are doing with your add-on."""),
...
"",_(u"""Let us start with a simple example: if you press NVDA+A, you would hear a tone for 1 second from any program. Since we want to use this everywhere, it must be a global plugin."""),
"",_(u"""First, if you haven't done so, enable development scratchpad. Then open your user configuration folder, then open scratchpad folder (if it exists), then select globalPlugins folder. Create a new .py file and give it a descriptive name such as example1.py (it is strongly recommended that when you name your global plugin file, give it a short descriptive name). Then open the newly created .py file in the word processor."""),
...
_(u"""		}"""),
"",_(u"""In Python, you put comments by putting hash sign (#) at the start of the comment line."""),
"",_(u"""### Example 1 code explanation"""),
"",_(u"""Our first example let's us sound a beep for one second when we press NVDA+A. But you might be wondering what that above code means, so let's step through the code, one piece at a time."""),
...
_(u"""6. Lastly, we wrote a simple dictionary (a collection) to store our command (script) bindings for our doBeep script. Here, we told NVDA to assign NVDA+A command for doBeep script."""),
...
"",_(u"""* Event: An event is a method that'll be run when some events happen, such as when a program is on focused, when names of controls change and so on."""),
_(u"""* Call: We say a function calls some another method when we run the second method from another method. For example, in our first example, we're calling tones.beep method from our script method."""),
...
_(u"""	* These have a corresponding method to set certain object as the focus or navigator object. Note that these lets NVDA see the new focus or navigator object but does not actually change system focus."""),
_(u"""	* `api.getDesktopObject()`: returns the shell (topmost level_ object)."""),
...
_(u"""* Build-in modules (builtin.py): Allows access to builtin modules when working with add-ons."""),
...
_(u"""* Hardware port utilities (hwPortUtils.py): A set of utilities for communicating over serial and other hardware ports, useful during driver add-on development."""),
_(u"""* IAccessible support (IAccessibleHandler.py, IAccessible objects): Used for supporting Microsoft Active Accessibility (MSAA)/IAccessible controls."""),
...
_(u"""	* `NVDAObjects.UIA`: various classes for objects powered by UI Automation. Since 2016, it is also the home of a collection of controls used in Microsoft Edge and objects powered by EdgeHTML rendering engine."""),
...
_(u"""* Speech output (speech.py): Controls speech output."""),
...
_(u"""	* `ui.message(message to be spoken/brailled)`: Speaks or brailles the message. This should be a string surrounded by quotes."""),
_(u"""	* `ui.browseableMessage(message to be shown, HTML or not)`: displays some text on a web browser window. If you want to use HTML markup, set isHTML argument to True."""),
...
"",_(u"""### Example 2: Display a message on a browse mode document"""),
"",_(u"""In NVDA 2015.2 and later, it became possible to display a message on a browse mode window so people can use browse mode commands to review the message content. The below code displays \"Hello world\" on a document window."""),
"",_(u"""	import ui"""),
_(u"""	"""),
_(u"""	ui.browseableMessage(\"Hello World!\", isHtml=False)"""),
"",_(u"""The isHtml flag tells NVDA to treat the message as an HTML text."""),
"",_(u"""### Example 3: Announce the automation ID of a UIA object"""),
"",_(u"""In UI Automation, automation ID is used to identify different screen elements. The following code displays this information on a browsable window."""),
"",_(u"""	import ui"""),
...
_(u"""			UIAElement = obj.UIAElement"""),
_(u"""			ui.browseableMessage(UIAElement.cachedAutomationId, isHtml=True)"""),
...
"",_(u"""This is just a sample of what various NVDA modules and functions can do in your add-on. We'll tour add-on components and meet more functions throughout this guide."""),
...
"",_(u"""Note that the NVDA core development guide introduces the below concepts. This chapter is intended as an extension of that document. Consult the NVDA development guide for a brief introductions."""),
...
"",_(u"""This guide sometimes suggests that you use the [Python Console]. The console is a feature of NVDA which can be very useful to developers. It is described in more detail in chapter 5 of the [NVDA Developer Guide][2]."""),
...
"",_(u"""Here are some other methods which works with NVDA objects, all located in api.py module:"""),
...
"",_(u"""### Example 3: Scripts for specific objects"""),
"",_(u"""As in specialist objects above, scripts can be assigned to certain objects by specifying gestures dictionary for this particular object. Here is an example from an app module which defines scripts for main window of a media player program:"""),
...
"",_(u"""As your write add-ons with scripts, you need to remember the following script lookup order when trying to assign commands to scripts:"""),
...
"",_(u"""### Few other remarks on scripts"""),
...
_(u"""* You can define the input help mode message for a script by using `__doc__` attribute (commonly known as docstrings). The __doc__ attribute is also used in Input Gestures dialog to show the description for a script."""),
_(u"""* If you need to leave one or more scripts unassigned (for example, if a gesture conflicts with a global command), do not include the gesture binding for the script in the gestures dictionary. This helps minimize gesture conflicts and allows users to assign custom gestures for scripts."""),
...
"",_(u"""### Example 4: Announcing the changed name of a control"""),
...
"",_(u"""Now we have a basic overview of components of add-ons, we're ready to build some simple add-ons. But first, let's go over the actual add-on development process, debugging tips, do's and don'ts and other tips."""),
...
"",_(u"""Q. What is difference between simple review and normal review and which one should I use?  """),
...
"",_(u"""Check if a global plugin which uses the command is installed. First, remove the global plugin and try again."""),
"",_(u"""Q. How can I use Win32 API in my add-on or object?"""),
"",_(u"""There is a document written by an add-on developer which talks about using Win32 API in your add-on. Select [this link][4] to view this document."""),
"",_(u"""Q. How can I create dialogs in my add-on?"""),
"",_(u"""You need to import two modules: GUI (import gui) and WXPython (import wx)."""),
...
"",_(u"""Yes. You'll need to use ConfigObj library (configObj) to manage configuration. Some add-ons (such as OCR) which uses configuration files store their configuration as an ini file in NVDA's user configuration folder. For global plugins, you can load and save user configuration from the add-on when the add-on is created (__init__) or finished (terminate), respectively. You cannot do this easily with app modules. Also, you'll need to provide a facility (commands, dialogs, etc.) where users can configure add-on settings."""),
...
"",_(u"""Q. I would like to port a module written in Python 3 syntax for use as an NVDA add-on."""),
"",_(u"""This cannot be done easily. One handy module for this purpose is six, which allows running Python 2 and 3 code. NVDA itself uses Python 2, and work is under way to transition to Python 3."""),
...
_(u"""* Last tested NVDA version (lastTestedNVDAVersion): tells NVDA the highest supported release for the add-on. Without this flag being set, NVDA will treat your add-ons as incompatible with the latest release."""),
...
"",_(u"""We did not include programming or Python-related FAQ's, as there are sites which answers questions about Python such as coding style. Consult these documents if you have issues with Python code."""),
"",_(u"""Now that we have covered basic add-on components, let's learn about how to package what you know in your add-on modules themselves: global plugins, app modules and drivers."""),
...
"",_(u"""### Few more things to remember about global plugins"""),
"",_(u"""* When you write scripts in your global plugin, the commands you assign to them will take precedence (looked up first). Therefore it is important to consult the NVDA user guide and help for other add-ons to minimize command conflicts."""),
...
_(u"""		script_toggleBrailleEntry.__doc__=\"Toggles braille entry on or off.\""""),
_(u"""		__gestures={"""),
_(u"""			\"kb:NVDA+X\":\"toggleBrailleEntry\""""),
_(u"""		}"""),
...
"",_(u"""	# The example app module for Notepad, notepad.py."""),
_(u"""	import appModuleHandler"""),
_(u"""	import api"""),
_(u"""	import ui"""),
_(u"""	"""),
...
"",_(u"""	# The example app module for a messenger app."""),
...
_(u"""* To support an application that works the same as another program (especially if you're writing app module for a 64-bit version of a 32-bit program for which you wrote an app module for), use the following code fragment (called aliasing):"""),
...
"",_(u"""### Few important things to remember before, during and after driver development"""),
"",_(u"""* Before writing a driver, make sure you have the needed software and/or hardware."""),
_(u"""* Be sure to study protocols and API's used by a speech synthesizer or a braille display (this is more so for braille displays which may implement different protocols)."""),
...
"",_(u"""To download or learn more about various add-ons created by NVDA users, visit [NVDA Community Add-ons web site][5]. You can browse currently available add-ons, view add-ons under development and read add-on development guidelines."""),
"",_(u"""For developers wishing to read the code that powers various add-ons, you can search for add-on repositories stored on GitHub. The NVDA community add-on developers use [Git][6] for version control."""),
"",_(u"""Some of the useful and educational add-on repositories are:"""),
"",_(u"""* [Add-on template](https://github.com/nvdaaddons/addonTemplate): this is the source code repository for the community add-on template."""),
_(u"""* [Place markers by Noelia Martinez](https://github.com/nvdaes/placeMarkers): adds place marker functionality and provides a good example on using text infos."""),
...
_(u"""* [StationPlaylist Studio by Joseph Lee](https://github.com/josephsl/stationPlaylist): improves usage of StationPlaylist Studio, provides interesting examples on overlay classes and app API, use of threads, and add-on dialogs and other user interfaces."""),
...
"",_(u"""* Add-on: an extension for a program. In NVDA world, an add-on refers to additional packages users can install to extend NVDA's functionality, improve support for an app, or add new speech synthesizers or braille displays."""),
...
_(u"""* Exception: one or more runtime circumstances that prevents normal operation of a program such as being denied access to a resource, name usage problem in code and other cases."""),
...
"",_(u"""| Task or feature | Global plugin | App module | Driver |"""),
_(u"""| ------- | --------- | -------- | -------- |"""),
_(u"""| Can be used everywhere | Yes | No | Yes |"""),
_(u"""| Naming restrictions | No (limited by Windows file naming conventions) | Must be name of the executable | No (limited by Windows file naming conventions) |"""),
_(u"""| Retrieve various controls, including focused control | Yes | Yes | No |"""),
_(u"""| Commands can be used everywhere | Yes | No | Braille display drivers only if defined |"""),
_(u"""| Handle events such as focus changes | Yes | Yes | No |"""),
_(u"""| Define custom objects to represent controls | Yes | Yes | No |"""),
_(u"""| Define custom actions to be performed when the module loads and unloads | Yes | Yes | Yes |"""),
_(u"""| Perform actions when profile switching occurs and other actions | Yes | Yes | Yes |"""),
_(u"""| Can modify object attributes at runtime | No | Yes | No |"""),
_(u"""| Modify speech and other output routines and presentation experience (i.e. speech.cancelSpeech, braille.handler.update, etc.) | Yes | yes | No |"""),
_(u"""| Include custom settings | Yes | Yes | Speech synthesizers only |"""),
_(u"""| Can patch NVDA functions, classes and modules at will | Yes | Not advised | No |"""),
_(u"""| Subject to configuration profile switches | No | Yes | Yes |"""),
_(u"""| Can call external libraries written in C and other languages and bundled as DLLs | Yes | Yes | Yes |"""),
...
_(u"""| I need pointers for providing improved support for a Java application | NVDAObjects.JAB and JABHandler module | Java Access Bridge (32-bit and 64-bit) should be installed. |"""),
...
_(u"""| Registry access | _winreg module | Changed to \"winreg\" in Python 3. |"""),
