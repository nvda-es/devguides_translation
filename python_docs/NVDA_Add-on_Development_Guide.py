...
"",_(u"""For more information on NVDA development, please visit the [NVDA Community Development page][1]. Be sure to go over the [NVDA Developer Guide][2] to familiarize yourself with key terms and basics on getting started with add-on development."""),
"",_(u"""## Audience"""),
...
"",_(u"""To edit .py files, you need a word processor which can handle .py files. The best one we recommend is Notepad++ which can be downloaded from https://notepad-plus-plus.org/download/v6.8.3.html."""),
...
_(u"""	* `ui.browsableMessage(message to be shown, HTML or not)`: displays some text on a web browser window. If you want to use HTML markup, set isHTML argument to True."""),
...
"",_(u"""	import ui"""),
_(u"""	"""),
_(u"""	ui.browsableMessage(\"Hello World!\", isHtml=False)"""),
...
_(u"""			ui.browsableMessage(UIAElement.cachedAutomationId, isHtml=True)"""),
...
_(u"""		keyboardHandler.KeyboardInputGesture.fromName(\"kb:applications\").send()"""),
...
"",_(u"""An example of the first case: modifying an atribute."""),
...
_(u"""2. Do ask for help if needed: If you're stuck, you can ask other add-on writers anytime for solutions or tips, or if you need to, ask for colaboration from other add-on developers."""),
...
_(u"""* Make sure you know how to communicate with your equipment or software - ports, USB ID's, Bluetooth addresses, serial port settings, DLL's and so on."""),
...
_(u"""* Class: definition of objects, including methods, attributes and expected behaviors. All Python classes and attributes are public; they can \"ecome private\" through use of naming conventions such as prefixing a variable name with underscores (_)."""),
...
_(u"""* Has versus is relationship: former refering to attributes of a single class, the latter refering to inherited classes."""),
...
_(u"""| Can call external libraries written in C and other languages and bundled as DLL's | Yes | Yes | Yes |"""),
...
_(u"""| providing input help message | script_somescript.__doc__ | Effectivley, a script's docstring is treated as its input help message. |"""),
...
"",_(u"""[1]: https://community.nvda-project.org/wiki/Developme"""),
