...
"",_(u"""* Latest version: December 2017 for NVDA 2017.4"""),
...
_(u"""* SCons 2, version 2.3.0 or later for generating add-on packages: <http://www.scons.org/>."""),
...
_(u"""	* `extensionPoints.Action`; notifies when something happens e.g. profile swithces."""),
...
"",_(u"""* Input handlers: if input from the braille display is desirable, the driver author must implement resonders for commands such as braille keys, routing buttons and additional hardware."""),
...
_(u"""| Position of a MSAA list item | item.IAccessibleChildID | Provided that this is properly implemented. The default for contorls other than list items, treeview items and what not is 0. |"""),
_(u"""| Automation ID for a UIA element | obj.UIAElement.cachedAutomationID | First, check if the object is a UIA contorl. |"""),
...
_(u"""| I need pointers for providing improved support for a Java application | NVDAObjects.JAB and JABHandler module | Java Access Bridge should be installed. |"""),
_(u"""| Adding support for an app that has similar functionality as another app | Import contents of the source app module via from appModuleName import * | |"""),
