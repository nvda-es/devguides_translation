...
_(u"""[add-on template]: https://bitbucket.org/nvdaaddonteam/addontemplate/get/master.zip"""),
...
_(u"""  - <a href=\"#user-content-example-2-display-a-message-in-a-browse-mode-document\">Example 2: Display a message in a browse mode document</a>"""),
...
_(u"""  - <a href=\"#user-content-a-few-other-remarks-on-scripts\">A few other remarks on scripts</a>"""),
...
_(u"""* The NVDA Community Add-on Template for ease of add-on file and folder packaging and management (optional: download the [add-on template]) ."""),
