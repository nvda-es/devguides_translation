...
_(u"""There are several ways in which you can contribute to the NVDA project:"""),
_(u"""- By testing NVDA"""),
_(u"""- Issue triage and investigation"""),
_(u"""- Code or documentation contributions"""),
...
_(u"""- It is recommended to wait for acceptance of your proposal before you start coding."""),
_(u"""  - Please understand that we very likely will not accept changes that are not discussed first."""),
_(u"""  - Consider starting a discussion on mailing lists (EG NVDA developers) to see if there is interest."""),
_(u"""- A minor/trivial change which definitely wouldn't require design, user experience or implementation discussion, you can just create a pull request rather than using an issue first."""),
_(u"""  - E.G. a fix for a typo/obvious coding error or a simple synthesizer/braille display driver"""),
_(u"""  - This should be fairly rare."""),
_(u"""- If in doubt, use an issue first. Use this issue to discuss the alternatives you have considered in regards to implementation, design, and user experience. Then give people time to offer feedback."""),
"","",_(u"""### GitHub process:"""),
_(u"""#### 1. \"fork\" the NVDA repository on GitHub"""),
_(u"""   When you fork the repository, GitHub will create a copy of the master branch."""),
_(u"""   However, this branch will not be updated when the official master branch is updated."""),
_(u"""   To ensure your work is always based on the latest commit in the official master branch, it is recommended that your master branch be linked to the official master branch, rather than the master branch in your GitHub fork."""),
_(u"""   If you have cloned your GitHub fork, you can do this from the command line as follows:"""),
_(u"""   ```"""),
...
_(u"""   git pull"""),
_(u"""   ```"""),
"",_(u"""#### 2. Use a separate \"topic\" branch for each contribution"""),
...
"",_(u"""#### 3. Run unit tests and lint check"""),
_(u"""   - Run `rununittests` (`rununittests.bat`) before you open your Pull Request, and make sure all the unit tests pass."""),
_(u"""   - If possible for your PR, please consider creating a set of unit tests to test your changes."""),
_(u"""   - The lint check ensures your changes comply with our code style expectations. Use `runlint nvaccess/master` (`runlint.bat`)"""),
"",_(u"""#### 4. Create a Pull Request (PR)"""),
_(u"""   When you think a contribution is ready, or you would like feedback, open a draft pull request."""),
_(u"""   Please fill out the Pull Request Template, including the checklist of considerations."""),
_(u"""   The checklist asks you to confirm that you have thought about each of the items, if any of the items are missing it is helpful to explain elsewhere in the PR why it has been left out."""),
_(u"""   When you would like a review, mark the PR as \"ready for review\"."""),
"",_(u"""#### 5. Participate in the code review process"""),
_(u"""   This process requires core NVDA developers to understand the intent of the change, read the code changes, asking questions or suggesting changes."""),
_(u"""   Please participate in this process, answering questions, and discussing the changes."""),
_(u"""   Being proactive will really help to speed up the process of code review."""),
_(u"""   When the PR is approved it will be merged, and the change will be active in the next Alpha build."""),
"",_(u"""#### 6. Feedback from Alpha users"""),
_(u"""   After a PR is merged, watch for feedback from Alpha users / testers."""),
_(u"""   You may have to follow up to address bugs or missed use-cases."""),
"",_(u"""## Code Style"""),
