...
_(u"""* Pull requests must be based on NVDA's master branch unless explicitly instructed to do otherwise by a lead developer."""),
_(u"""* Submitted pull requests should not contain edits to changes.t2t. Instead, change log entries should be placed in the pull request description, under the appropriate section in the template."""),
_(u"""* All pull requests submitted must have their \"Allow edits from maintainers\" checkbox ticked. This is usually the case for all new pull requests. """),
