...
_(u"""		lineNum = lineNumList[2]+lineNumList[3]"""),
...
"",_(u"""Your add-on:"""),
"",_(u"""1. Must be licensed under GNU General Public license (GPL) 2 or later or equivalent which allows a GPL software such as NVDA to incorporate your code while it runs."""),
...
_(u"""3. Must be compatible with latest base API release (as of January 2021, base API is 2019.3)."""),
