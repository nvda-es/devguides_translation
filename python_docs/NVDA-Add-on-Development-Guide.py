...
"",_(u"""Latest version: August 2019 for NVDA 2019.2"""),
"",_(u"""IMPORTANT: the NVDA community is in the midst of a Python 3 transition. Many examples from this guide will work on both Python 2 and 3 unless otherwise specified."""),
"",_(u"""---"""),
...
"",_(u"""Add-ons can act globally (across all of NVDA), in a specific application or program, or behind the scenes (at the hardware or software level). We call these three """),
...
_(u"""    - Even better: we recommend installing the latest master (alpha) or beta development version to keep up to date with core API changes. You can download the latest snapshots at https://community.nvda-project.org/wiki/Snapshots."""),
_(u"""* Python:"""),
_(u"""    - Python 2.7 series, version 2.7.16 32-bit for Windows: https://www.python.org/downloads/release/python-2716/"""),
_(u"""    - If you wish to work with Python 3, use Python 3.7.4, 32-bit for Windows: https://www.python.org/downloads/release/python-374/"""),
_(u"""    - Starting from July 2019, Python 3 is required."""),
...
_(u"""		import wx, gui				# We need these for working with dialogs and windows"""),
...
_(u"""* Monitor things in the background without interupting NVDA. For example, an overlay class defined in an app module can use a thread to announce screen information as it changes in the background."""),
...
"",_(u"""One limitation with threading.Timer is that it does not support repetetive tasks, and for these, you need to use wx.Timer."""),
...
_(u"""| Default text format | ANSI | Unicode | Unicode is prefered. To do so, prefix text with a \"u\". |"""),
