...
"",_(u"""Latest version: November 2019 for NVDA 2019.2"""),
...
"",_(u"""If you are coming from NVDA 2018.4 or earlier, you may recall that you are able to run extension modules (sometikmes claled \"plugins\") inside folders stored in the user configuration directory (e.g. appModules). This functionality has been revised in NVDA 2019.1 as follows:"""),
...
"",_(u"""## Enhancers"""),
"",_(u"""An enhancer is a module that helps certain groups of users use computers more efficiently. These may include cursor tracking, magnification, and other enhancements."""),
...
_(u"""* Startup check: a routine that will ensure NVDA is running on a specific environment where the enhancer would be most helpful, such as ehcking for a specific Windows release."""),
_(u"""* Startup and shutdown: a class constructor that instructs the enhancer to come online and a \"termiante\" method that shuts it down."""),
