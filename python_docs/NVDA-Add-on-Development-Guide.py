...
_(u"""    - `ui.browseableMessage(message to be shown, HTML or not)`: displays some text in a web browser window. If you want to use HTML markup, set isHTML argument to True."""),
