...
"",_(u"""Latest version: July 2020 for NVDA 2020.2"""),
"",_(u"""---"""),
...
"",_(u"""In addition to the modified example 2, the below example will add input help message for both scripts, along with letting Control+NVDA+3 to let NVDA say \"good bye\"."""),
