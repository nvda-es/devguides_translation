# -*- coding: utf-8 -*-
documentation = [
_(u"""[//]: # (Translators: delete the table of contents before translating. Regenerate after translation if possible, or don't include in translated version)"""),
...
_(u"""    - [Example 3: Scripts for specific objects](#user-content-example-3-scripts-for-specific-objects)"""),
...
_(u"""    - [Example 4: Announcing the changed name of a control](#user-content-example-4-announcing-the-changed-name-of-a-control)"""),
...
_(u"""    - [Few more things to remember about global plugins](#user-content-few-more-things-to-remember-about-global-plugins)"""),
...
_(u"""    - [Few important things to remember before, during and after driver development](#user-content-few-important-things-to-remember-before-during-and-after-driver-development)"""),
...
_(u"""- [Appendicies](#user-content-appendicies)"""),
...
"",_(u"""This guide was originally written by Joseph Lee ([@josephsl](https://github.com/josephsl)), and is shaped by the NVDA user and developer community. As of May, 2019, it is being maintained and revised by Luke Davis ([@XLTechie](https://github.com/XLTechie)). We welcome your feedback and contributions."""),
...
"",_(u"""Note: if you're using Windows 10 Anniversary Update or later and wish to use Ubuntu on Windows (AKA [Windows Subsystem for Linux][WSL]), you can use Advanced Packaging Tool (APT) to obtain SCons and Gettext. You can then use pip to download and install Markdown."""),
