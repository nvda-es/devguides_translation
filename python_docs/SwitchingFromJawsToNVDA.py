...
"",_(u"""NVDA does not provide a dialog to access the notification area, as this is accessible natively.  Press WINDOWS+B to access the notification area, then use the arrow keys to move between items.  Pressing spacebar on an icon is the same as left clicking the mouse.  Pressing enter is the same as double-clicking the left mouse button (there is no distinction between these in Windows 10).  Pressing the applications key or or shift+f10 to open the context menu for an item."""),
