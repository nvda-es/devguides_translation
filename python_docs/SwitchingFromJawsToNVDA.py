...
"",_(u"""## NVDA's Desktop and Laptop Keyboard Layouts"""),
"",_(u"""NVDA uses \"Desktop\" keyboard layout by default.  This layout uses the number pad (with numlock off) for review cursor and object navigation commands (more on those further down).  Laptop Keyboard layout is designed for keyboards without a number pad.  Those commands are moved to other keys, as are a number of other commands."""),
"",_(u"""Selecting the laptop keyboard layout does not automatically set the CapsLock key to act as the NVDA modifier key.  Keyboard layout and NVDA key can be set independently from NVDA's keyboard settings.  Checkboxes are provided to select caps lock, numpad insert, or extended insert.  Any combination of these keys can be selected regardless of the keyboard layout selected.  Press NVDA+control+k to open NVDA's keyboard layout settings."""),
"",_(u"""## Getting Started With NVDA"""),
"",_(u"""The [NVDA User Guide](https://www.nvaccess.org/files/nvda/documentation/userGuide.html) contains all NVDA commands.  Here are some basic commands which are used frequently.  All commands are configurable, so these are the default keystrokes for these functions.  As noted previously, your NVDA key can be either insert or caps lock."""),
"",_(u"""Most NVDA functions can be enabled or changed via the NVDA settings.  Settings, and other options, are available via NVDA's menu.  To open NVDA's menu, press NVDA+n.  To open NVDA's settings dialog directly, press NVDA+control+g.  Many settings screens have keystrokes to open them directly, such as NVDA+control+s for synthesizer, or NVDA+control+v for other voice options."""),
"",_(u"""* Start NVDA: Press control+alt+n"""),
_(u"""* Exit NVDA: NVDA+Q, then enter."""),
_(u"""* Pause or restart speech: shift"""),
_(u"""* Stop speech: control"""),
_(u"""* Report window title: NVDA+t"""),
_(u"""* Report current focus: NVDA+tab"""),
_(u"""* Report time: NVDA+f12 (press twice quickly for date)"""),
_(u"""* Toggle speak typed characters: NVDA+2"""),
_(u"""* Toggle speak typed words: NVDA+3"""),
_(u"""* Toggle speak command keys: NVDA+4"""),
_(u"""* Report battery: NVDA+Shift+b"""),
_(u"""* Toggle input help mode (read each key without performing an action): NVDA+1"""),
_(u"""* Report status bar: NVDA+end (desktop layout) / NVDA+shift+end (laptop layout)"""),
_(u"""* Read the current line: NVDA+up arrow (desktop keyboard layout) / NVDA+l (laptop keyboard layout)"""),
_(u"""* Say all (Read from the current point onwards): NVDA+down arrow (desktop layout) / NVDA+a (laptop layout)"""),
_(u"""* Report clipboard: NVDA+c"""),
_(u"""* Read selected text: NVDA+shift+up arrow (desktop layout) / NVDA+shift+s (laptop layout)"""),
_(u"""* Report text formatting: NVDA+f"""),
_(u"""* Adjust speech options: NVDA+control+arrows (desktop layout) / NVDA+shift+control+arrows (laptop layout) - refer to the [Synth Settings Ring in the User Guide](https://www.nvaccess.org/files/nvda/documentation/userGuide.html#SynthSettingsRing) for more information"""),
_(u"""* Open Elements list (similar to Jaws' links list): NVDA+f7 (Note that many single letter navigation keys such as H for heading, N for non-linked text or F for form field, are the same as used in Jaws)."""),
"",_(u"""To get help for NVDA, press NVDA+n to open the menu, then H for help.  From this submenu you can access the User Guide, a quick reference of commands, history of new features and more.  These first three options open in the default web browser.  There is also more comprehensitve [Training Material available in the NV Access Shop](https://www.nvaccess.org/shop/)."""),
...
"",_(u"""### Progress bar announcement"""),
"",_(u"""JAWS has only single type of progress bar announcement E.G speaking the percentage as it changes. In NVDA, This can be done verbally (\"5%\", \"6%\", \"23%\", etc), as beeps, increasing in pitch, or both.  To adjust this, press NVDA+U.  Alternatively, it is available from the Object Presentation settings.  Press NVDA+control+o to open these settings."""),
