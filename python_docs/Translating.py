...
_(u"""You can subscribe to NVDA translations mailing list [here](https://groups.io/g/nvda-translations)"""),
_(u"""hosted at Groups.IO."""),
"",_(u"""It is an English low trafic list devoted for the discussion of translation. """),
_(u"""Important messages that relate to translators will also be sent here, i.e. before NVDA official releases, to remind translators to make sure their localization is up to date."""),
"",_(u"""## Important Dates"""),
...
"",_(u"""Status for existing NVDA localizations are provided below. If you would like to improve or would like to work on a new language, please write to NVDA translations email list."""),
_(u"""Information updated as of August 2017 (2017.3)."""),
_(u"""When 2017.3 is listed in the last updated column, it means that the localization is fully up to date and will be ready for the next release. For the purposes of the information below, \"up to date\" refers to interface translation of at least 90%."""),
...
_(u"""| an: Aragonese | Up to date. | 2018.3 |"""),
_(u"""| ar: Arabic | Up to date. | 2018.3 |"""),
_(u"""| bg: Bulgarian | Up to date. | 2018.3 |"""),
_(u"""| CA: Catalan | Up to date. | 2018.2 |"""),
_(u"""| CKB: Central Kurdish | In progress. | N/A |"""),
_(u"""| cs: Czech | Up to date. | 2018.3 | """),
_(u"""| da: Danish | Up to date. | 2018.3 | """),
_(u"""| de: German | Up to date. | 2018.3 | """),
_(u"""| de_CH: Swiss German | Up to date. | 2018.3 | """),
_(u"""| el: Greek | The NVDA interface is up to date. There is work to be done on the user's guide. | 2018.3 |"""),
_(u"""| es: Spanish | Up to date. | 2018.3 | """),
_(u"""| es_CO: Spanish (Columbia) | NVDA interface needs updating. There is work to be done on the user's guide. | July 2016 |"""),
_(u"""| fa: Farsi | Up to date. | 2017.3 |"""),
_(u"""| fi: Finnish | Up to date. | 2018.3 | """),
_(u"""| fr: French | Up to date. | 2018.3 | """),
_(u"""| ga: Gaeilge (Ireland) | Update in progress. | 2016.3 |"""),
_(u"""| gl: Galician | Up to date. | 2018.3 | """),
_(u"""| he: Hebrew | Up to date. | 2018.2 |"""),
_(u"""| hi: Hindi | Not complete, intermittent, help needed. | Jan 2015 |"""),
_(u"""| hr: Croatian | Up to date. | 2018.3 |"""),
