...
"",_(u"""Note that due to Espeak issues, transition workflow must be done from Windows 10. Once Espeak is ready, this requirement will be relaxed. Also, as of September 2018, add-ons won't work, so do NOT install any of them into the source code copy of NVDA."""),
...
_(u"""* Windows 10 SDK (build 17134) (mandatory)"""),
...
"",_(u"""### Debuggin Python 3 transition work"""),
...
_(u"""2. Console (testing an idea or find out how Python 3 modules work): Python Console can be used."""),
...
"",_(u"""Start date: September 17, 2018 (tentative designation)"""),
...
_(u"""	* As of September 20, 2018, at least 15 issues were identified, along with several pull requests."""),
...
_(u"""	* As of September 20, 2018, at least one transition related pull request was submitted and merged into master branch."""),
