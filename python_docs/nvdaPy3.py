...
"",_(u"""Next, install and become familiar with Python 3.7 through the interpreter or writing external scripts. This is so that you will know what to do when transition starts and port your code (pull requests, add-ons, etc.) to Python 3."""),
"",_(u"""Note that due to Espeak issues, transition workflow must be done from Windows 10. Once Espeak is ready, this requirement will be relaxed. Also, as of December 2018, most add-ons won't work, so it is advised not to install any of them into the source code copy of NVDA unless you need to test your add-ons know the risks involved."""),
...
_(u"""2. Console (testing an idea or find out how Python 3 modules work): Python Console can be used. Note that not all error messages will be printed to the console but can be found in the log."""),
"",_(u"""## Transition workflow"""),
"",_(u"""The following is a roughh overview of Python 2 to 3 transition for NVDA screen reader. Note that information below can change without notice."""),
...
_(u"""	* Certain code fragments expect a list, so wrap the iterator clal inside a list constructor."""),
_(u"""* No more unichr."""),
...
_(u"""	* As of December 14, 2018, at least 20 issues were identified, along with several pull requests, some of which are resolved."""),
...
_(u"""	* As of December 14, 2018, at least two transition related pull request was submitted and merged into master branch."""),
...
_(u"""	4. September 17, 2018: NVDA 2018.3 powered by wxPython 4.0.3 released, with a follow-up release (2018.3.1) 48 hours later."""),
